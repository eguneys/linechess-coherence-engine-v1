...
import { show_index_ply } from "./Evaluator";
        ...
        <div class='panel'>
          <div class='body'>
            ...
            <div class='input-group'>
              ...
              <input autocomplete="off" minLength={3} required={true} ref={$opening_line_name_text} id="opening_line_name" type='text' placeholder="e.g. 3.e5 c5 Advanced Variation"></input>
            </div>
          </div>
